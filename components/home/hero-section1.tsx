...
export default function HeroSection() {
  ...
  // Get hero content
  const heroTitle = getContentText("home-hero");
  const heroSubtitle = getContentArray("home-hero", ["Welcome to Elextrio Automation", "Innovative solutions for industrial automation"])[1] || "Innovative solutions for industrial automation";
